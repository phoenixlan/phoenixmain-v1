...
<div class="contentSimulator">
    ...
    <div class="content">
        <div class="content-inner">
            ...
            <p>Alle mot alle, Hunger Games style. Tre runder vil kjøres totalt. Total poengsum fra de tre rundene vil bestemme vinner, så lurt å slenge seg med på alt! Påmelding gjøres via <a href="https://forms.gle/xZwvawoon7MAWYCc9" target="_blank">Google Forms</a>!</p>
            <h5>Poeng:</h5>
            <ul>
                <li>1 kill: 2pts</li>
                <li>1 win: 3pts</li>
